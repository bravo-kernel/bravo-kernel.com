...
Please be aware that manually updating message catalog files is **highly discouraged**. Alternatives like the
...
Lastly, it is **highly recommended** to try the free version of [Crowdin](https://crowdin.com) which provides more than sufficient
